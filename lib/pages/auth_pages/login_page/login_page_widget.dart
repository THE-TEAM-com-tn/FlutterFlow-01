...
import '../../../api/ConnectedScreen.dart';
...
class _LoginPageWidgetState extends State<LoginPageWidget> {
 // late LoginPageModel _model;
  ...
  void _login() async {
    ...
    // Call your AuthApi login method
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ConnectedScreen()));
    } else {
      // Show error message
                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: SelectionArea(
                                                  ...
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'kimnzqyq' /* Login into your account */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .headlineSmall
                                            ...
                                            Align(
                                              ...
                                              child: SelectionArea(
                                                ...
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '28fyes4y' /* Welcome back! Please login to ... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
