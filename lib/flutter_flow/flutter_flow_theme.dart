...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF119B78);
  late Color secondary = const Color(0xFFD48941);
  ...
  late Color tertiaryText = const Color(0xFF4E5665);
  late Color textfieldBorderColor = const Color(0xFFD0D5DD);
  late Color backgroundComponents = const Color(0xFF1D2428);
  late Color night = const Color(0xFF131515);
  late Color jet = const Color(0xFF2B2C28);
  late Color persianGreen = const Color(0xFF339989);
  late Color tiffanyBlue = const Color(0xFF7DE2D1);
  late Color snow = const Color(0xFFFFFAFB);
  late Color light700 = const Color(0xFFB2B3B4);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiaryText = const Color(0xBEFFFFFF);
  late Color textfieldBorderColor = const Color(0x33FFFFFF);
  late Color backgroundComponents = const Color(0xFF1D2428);
  late Color night = const Color(0xFF131515);
  late Color jet = const Color(0xFF2B2C28);
  late Color persianGreen = const Color(0xFF339989);
